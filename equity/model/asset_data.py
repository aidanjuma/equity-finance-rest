...
class AssetData():
    def __init__(self, ticker: str, market: str, google_finance_url: str, label: str, currency: dict, price: float, market_cap: int, price_range: dict, about: dict, news: dict) -> None:
        self.ticker = ticker
        self.market = market
